(function() {
    ...
    function init() {
       ...
       /*  document.body.appendChild(container);
        ...
        document.getElementById("first_item").appendChild(container);
        document.getElementById("first_item").style.margin = "0";
        
        document.getElementById("first_item").style.padding = "0";
        //document.getElementById("first_item").style.overflow = 'hidden';
        //document.getElementById("first_item").style.border="3px yellow solid";
	...
	you're gonna see some serious shit.	*/
        ...
        */
        ...
        window.addEventListener('resize', onWindowResize, false);
        document.getElementById("first_item").addEventListener('mousemove', onDocumentMouseMove, false);
        //document.getElementById("first_item").addEventListener('touchstart', onDocumentTouchStart, false);
        //document.getElementById("first_item").addEventListener('touchmove', onDocumentTouchMove, false);
